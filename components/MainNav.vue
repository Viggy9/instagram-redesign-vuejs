        ...
        <v-layout>
          <v-flex text-center>
            ...
            <v-avatar class="outlined" size="80">
              <v-avatar size="70">
                <v-img
                  src="https://imagevars.gulfnews.com/2019/08/14/Rahul-Dravid_16c8f3cd54e_large.jpg"
                />
              </v-avatar>
            </v-avatar>
            ...
            <div class="mt-4 title">Rahul Dravid</div>
            <div class="mt-1 subtitle-2 grey--text">Bangalore, India</div>
            <div class="mt-5">
              <v-layout>
                <v-flex>
                  <div class="subtitle-2">Post</div>
                  <div class="subtitle-2 grey--text">200</div>
                </v-flex>
                <v-flex>
                  <div class="subtitle-2">Followers</div>
                  <div class="subtitle-2 grey--text">10m</div>
                </v-flex>
                <v-flex>
